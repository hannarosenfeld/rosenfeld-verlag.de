...
const Impressum = () => (
    <Layout>
      <div>
        ...
        <h3>Copyright</h3>
        <p>
          © Copyright 2022 Rosenfeld Verlag/Rosenfeld CC GmbH, Weimar und Frankfurt am Main, Deutschland
          Alle Rechte vorbehalten. Alle Inhalte, wie Text, Bilder, Grafiken, Sound, Animationen und Videos sowie deren Anordnung auf den Websites des Rosenfeld Verlags, unterliegen dem Schutz des Urheberrechts und anderer Schutzgesetze. Der Inhalt dieser Websites darf nicht zu kommerziellen Zwecken kopiert, verbreitet, verändert oder Dritten zugänglich gemacht werden. Einige Rosenfeld Verlag Websites enthalten außerdem Inhalte, die dem Copyright Dritter unterliegen oder unterliegen können.
        </p>
      </div>
      <br/>
      <br/>
      ...
      <div id="datenschutz">
        ...
        <ol>
          ...
          <li>Datenverarbeitung über unsere Website</li>
        </ol>
        <br/>
        <div>
          <b>1. Name und Kontaktdaten der verantwortlichen Stelle</b>
          <p>Diese Datenschutzhinweise gelten für uns, Rosenfeld CC GmbH</p>
          <p>Geschäftsführer: Theo Rosenfeld</p>
          <p>Erfurter Str. 104</p>
          <p>E-Mail: info@rosenfeld.cc</p>
          <p>als verantwortliche Stelle.</p>
        </div>
        <br/>
        <div>
          <b>2. Erhebung und Speicherung personenbezogener Daten; Art, Zweck und Verwendung</b>
    ...
    <li>Auskunftsrecht: Sie können Auskunft über Ihre von uns verarbeiteten personenbezogenen Daten verlangen. Dies gilt insbesondere für die Zwecke der Datenverarbeitungen, die Kategorien der personenbezogenen Daten, ggf. die Kategorien von Empfängern, die Speicherdauer, ggf. die Herkunft Ihrer Daten sowie ggf. für das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling und ggf. aussagekräftigen Informationen zu deren Details.</li>

    <li>Berichtigungsrecht: Sie können die Berichtigung unrichtiger oder die Vervollständigung Ihrer bei uns gespeicherten personenbezogenen Daten verlangen.</li>
    ...
    <li>Recht auf Datenübertragbarkeit: Sie können verlangen, dass wir Ihnen Ihre personenbezogenen Daten, die Sie uns bereitgestellt haben, in einem strukturierten, gängigen und maschinenlesebaren Format übermitteln. Alternativ können Sie die direkte Übermittlung der von Ihnen uns bereitgestellten personenbezogenen Daten an einen anderen Verantwortlichen verlangen, soweit dies möglich ist.</li>
        ...
        <li>Beschwerderecht: Sie können sich bei der für uns zuständigen Aufsichtsbehörde beschweren, z.B. wenn Sie der Ansicht sind, dass wir Ihre personenbezogenen Daten in unrechtmäßiger Weise verarbeiten. Die für uns zuständige Behörde ist: Der Hessische Beauftragte für Datenschutz und Informationsfreiheit, Postfach 3163, 65021 Wiesbaden.</li>
        </ul>
        </div>
        <br/>
        <div>
        <b>5. Ihr Recht auf Widerspruch</b>
        ...
        <br/>
        <div>
        <b>6. Datenverarbeitung über unsere Website</b>
          Auch über unsere Internetseite unter www.rosenfeld-verlag.de erfolgt die Verarbeitung bestimmter personenbezogener Daten, u.a. der IP-Adresse der Website-Besucher. Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log Files, die Ihr Browser automatisch an uns übermittelt. Dies sind:
          <ul>
